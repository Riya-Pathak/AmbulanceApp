...
public class UserSens extends AppCompatActivity {
    ...
    String Username,emergency,aadhaar,age;
    ProgressDialog progressDialog;
    Handler handler = new Handler(Looper.getMainLooper());
    TextView username,aadhaartext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  seeuser = (Button) findViewById(R.id.seeuser);
...
//                            String username = jsonObject.getString("");
                            ...
                            //  Toast.makeText(getApplicationContext(),"latitude is "+locationofuserlat,Toast.LENGTH_LONG).show();
                            // Toast.makeText(getApplicationContext(),"longitude is "+locationofuserlong,Toast.LENGTH_LONG).show();
       ...
       agetext.setText(age);
        ...
        if (locationofuserlat>0&&locationofuserlong>0){
            ...
            notification.setTicker("this is fuck");
            ...
            Intent notificationIntent = new Intent(this, MainControlActivity.class);
